...
- São muito úteis para executar procedimentos similares repetidas vezes;
...
Onde:
nome_da_função -> sempre com letras minúsculas e se for nome composto, separado com underline (Snake Case)
parametros_de_entrada -> são opcionais, onde, tendo mais de um, cada um separado por vírgula;
...
# Em Python podemos inclusive crirar variáveis do tipo de uma função e executar esta função através da variável
